...
public class SimpleNeuralsTest {
    ...
    public static int inputLayerSize=3;
    public static int layer1Size=7;
    ...
    public static void main(String[]args){
        ...
        Start(0,0,0);
        for(int i=0;i<layer2Size;i++){
            System.out.println(layer2.get(i).output);
        }
        System.out.println();
        Clear();
